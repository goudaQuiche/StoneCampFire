...
{
    public class MyGraphic_Flicker : Graphic_Collection
    {
        ...
        public override void DrawWorker(Vector3 loc, Rot4 rot, ThingDef thingDef, Thing thing, float extraRotation)
        {
            ...
            CompProperties_LightableFireOverlay compProperties_FireOverlay = null;
            ...
            {
                compProperties_FireOverlay = thingDef.GetCompProperties<CompProperties_LightableFireOverlay>();
                if (compProperties_FireOverlay != null)
                {
                    num4 = compProperties_FireOverlay.fireSize * extraRotation;
                }
            }
