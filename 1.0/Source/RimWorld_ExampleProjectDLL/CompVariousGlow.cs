...
namespace StoneCampFire
{
	public class CompVariousGlow : ThingComp
    {
        ...
        public void UnsetGlow(Map forcedMap=null)
        {
            if (glowComp == null)
            {
                Tools.Warn("cant unset null glow", true);
                return;
            }
            Map myMap;
            ...
            if (forcedMap != null)
            {
                ...
                if (myMap == null)
                {
                    Tools.Warn("cant unset null map glow", true);
                    return;
                }
            }
            else
        ...
        {
            Tools.Warn("Fuel : " + value + ";Threshold : " + Props.threshold, true);

            if (value > Props.threshold)
            {
                SetLightGlow();
                Tools.Warn("Light glow set", true);
            }
            else
            {
                SetDarkGlow();
                Tools.Warn("Dark glow set", true);
            }
